...
#Create the User Table (parent of BlogPost)
class User(UserMixin, db.Model):
    ...
    # bidirectional relationship with BlogPost class
    posts = relationship("BlogPost", back_populates="author")
    # bidirectional relationship with Comment class
...
# chidren of UserMixin are automatically added to the User class
